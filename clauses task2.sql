...
select * from e_commerce_order where product_name='laptop';
select * from e_commerce_orders where order_date>'2025-10-05' and order_date <'2025-10-15';
...
select product_name from e_commerce_orders where price > 100 and price < 500; 
